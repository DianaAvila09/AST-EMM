<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vigilantesReg.aspx.cs" Inherits="CapaPresentacion.catalogos.vigilantesReg" %>
...
<body>
    <div class="container">
        <form id="form1" runat="server" autocomplete="off">
             ...
             <div class="row mt-4">
                <div class="col">
                    <h3> Actualizador a grupo de vigilantes</h3>
                    <hr />
                </div>
              </div>
            ...
            <div class="mb-3">
             ...
             <div class="mb-3">
                ...
                <dx:ASPxTextBox ID="txtEmail" runat="server"   Width="100%" Theme="Aqua" BackColor="#F8F8F8"  Height="25px" Font-Names="Segoe UI" Font-Size="Medium" >
                </dx:ASPxTextBox>
