<%@ Page language="C#" AutoEventWireup="true" CodeBehind="vigilantesQuery.aspx.cs" Inherits="CapaPresentacion.catalogos.vigilantesQuery"%> 
        ...
        <div class="contenedor">
            <form id="form1" runat="server">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-auto">
                         <asp:Button CssClass="btn btn-primary btn-sm" runat="server" Text="Agregar vigilante" OnClick="agregar_Click" ></asp:Button>
                    </div>
                     <div class="col-auto">
                ...
                <div class="row mt-2">
                        <div class="col">
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%" Theme="Aqua" AutoGenerateColumns="False" EnableTheming="True" Font-Names="segoe ui,medium" Font-Size="Small" KeyFieldName="vigilancia_id" ClientInstanceName="gvDoctos">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Id" VisibleIndex="0" FieldName="vigilancia_id" Width="40px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Estatus" ShowInCustomizationForm="True" VisibleIndex="3" Width="80px" FieldName="estatus">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Nombre del Vigilante" FieldName="nombre" VisibleIndex="1" Width="300px">
                                </dx:GridViewDataTextColumn>
                            </Columns>
                            </dx:ASPxGridView>
                    </div>
