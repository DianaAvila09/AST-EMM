...
{
    public partial class deptosQuery : System.Web.UI.Page
    {
        ...
        {
            ASPxGridView1.DataSource = objCatalogos.DeptosQuery();
        ...
        {
            Response.Redirect("deptosReg.aspx");
        }
        ...
        protected void btnUpd_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("deptosReg.aspx?id=" + intKey );
