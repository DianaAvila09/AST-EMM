...
<body>
        ...
        <div class="contenedor">
            <form id="form1" runat="server">
                ...
                <div class="row">
                    <div class="col">
                        <h3> Consulta Tipo de Documentos</h3>
                        <hr />
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-auto">
                         <asp:Button CssClass="btn btn-primary btn-sm" runat="server" Text="Agregar nuevo documento" OnClick="agregar_Click" ></asp:Button>
                    </div>
                     <div class="col-auto">
