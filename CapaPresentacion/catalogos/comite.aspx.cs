...
{
    public partial class comite : System.Web.UI.Page
    {
        ...
        {
            ASPxGridView1.DataSource = objCatalogos.ComiteQuery();
        ...
        {
            Response.Redirect("comiteReg.aspx");
        }
        ...
        protected void btnUpd_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("comiteReg.aspx?id=" + intKey );
