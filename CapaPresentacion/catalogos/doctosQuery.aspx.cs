...
{
    public partial class doctosQuery : System.Web.UI.Page
    {
        ...
        {
            ASPxGridView1.DataSource = objCatalogos.DoctosQuery();
        ...
        {
            Response.Redirect("doctosReg.aspx");
        }
        ...
        protected void btnUpd_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("doctosReg.aspx?id=" + intKey );
