...
{
    public partial class autorizaDocAstv2 : System.Web.UI.Page
    {
        bool _botonNuevo  ;
        ...
        protected void BucarAST_Formato()
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                this.hfUserIdElaboro["value"] = Convert.ToInt16(dr["user_id"].ToString());
       ...
       protected void ActStatus()
        ...
        {
            _astid = Convert.ToInt32(Request.QueryString["astid"]);
            Response.Redirect("autorizacomite.aspx?astid=" + _astid + "&vigid=" + _comiteId +  "&approvedstatus=0");
        }

        protected void btnRechaza_Click(object sender, EventArgs e)
        {
            _astid = Convert.ToInt32(Request.QueryString["astid"]);
            Response.Redirect("autorizacomite.aspx?astid=" + _astid + "&vigid=" + _comiteId + "&approvedstatus=1" );
        }
    }
}